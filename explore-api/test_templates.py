...
# Test parse
parsed = parse_skill_md("/root/.hermes/skills/agenthub-templates/ai-researcher/SKILL.md")
...
# Test preview
rendered = render_preview("/root/.hermes/skills/agenthub-templates/ai-researcher/SKILL.md")
...
# Test 404 case
not_found = parse_skill_md("/root/.hermes/skills/agenthub-templates/nonexistent/SKILL.md")
